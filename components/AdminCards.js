...
const AdminCards = ({ channel }) => {
  ...
  return (
    <>
        ...
        <div className=" grid grid-cols-[20%_30%_30%_10%] gap-2 md:gap-6 lg:grid-cols-[10%_20%_30%_25%_5%]">
          <div>
            <div className="border-slate-300 border-r lg:justify-center lg:flex">
              <Image className="rounded-lg" priority={channel.id} src={channel.avatar} alt="" width={80} height={80} />
            </div>
          </div>
